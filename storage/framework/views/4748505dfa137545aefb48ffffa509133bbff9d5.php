                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                            ...
                                            <?php $__currentLoopData = $Portfolio; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr class="odd gradeX">
                                                    ...
                                                    <?php $__currentLoopData = $Servicee; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $servicee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php echo e($servicee->title); ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

                                                    </td>
                                                    <td><?php echo e($value->client); ?></td>

                                                    <td class="center"><img width="80" height="80" src="<?php echo e(url('/')); ?>/uploads/portfolio/<?php echo e($value->image_one); ?>"></td>
                                                    <td class="center">
                                                        <a href="<?php echo e(url('/admin')); ?>/editPortfolio/<?php echo e($value->id); ?>"   class="btn btn-info"><i class="icon-pencil icon-white"></i> Edit</a>
                                                        <br><br>
                                                        <a href="<?php echo e(url('/admin')); ?>/dropzone/<?php echo e($value->id); ?>"   class="btn btn-info"><i class="icon-image icon-white"></i> Add Images (<?php echo count($PortFolio = DB::table('photos')->where('portfolio_id',$value->id)->get()) ?>)</a>
                                                    </td>
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/designekta/stagepassRevamps/resources/views/admin/portfolio.blade.php ENDPATH**/ ?>