                                ...
                                <ul class="chat">
                                    ...
                                    <li class="left clearfix">
                                        ...
                                        <div class="chat-body clearfix">
                                            <div class="header">
                                                <strong class="primary-font "> <?php echo e($comment->author); ?></strong>
                                                <small class="pull-right text-muted label label-success">
                                                   <a style="color:#ffffff;" onclick="return confirm('Approving this Comment Automatically Sends It to the Websites Front-End, Do You Wish to Continue')" href="<?php echo e(url('/admin/approve')); ?>/<?php echo e($comment->id); ?>"> <i class="icon-check"></i> Approve </a>
                                                </small>

                                                <small class="pull-right text-muted label label-danger">
                                                   <a style="color:#ffffff;" onclick="return confirm('Are You Sure You Want To Delete This Comment? You Cannot Undo After This Action')" href="<?php echo e(url('/admin/decline')); ?>/<?php echo e($comment->id); ?>"> <i class="icon-trash"></i> Delete </a>
                                                </small>
                                            </div>
                                             <br />
                                            <p>
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/designekta/stagepassRevamps/resources/views/admin/index.blade.php ENDPATH**/ ?>