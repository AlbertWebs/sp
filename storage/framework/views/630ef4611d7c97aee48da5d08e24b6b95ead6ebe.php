				...
				<?php endif; ?>
                 ...
                 <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input type="text" id="text1" name="link" value="<?php echo e($Portfolio->link); ?>" placeholder="e.g https://www.julietwangui.com" class="form-control" />
                        </div>
                    </div>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input type="text" id="text1" name="venue" value="<?php echo e($Portfolio->venue); ?>" placeholder="Ghana" class="form-control" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input type="text" id="text1" name="audience" value="<?php echo e($Portfolio->audience); ?>" placeholder="10000" class="form-control" />
                        </div>
                    </div>
                    ...
                    <div class="col-lg-8">
                        ...
                        <?php $Servicee = DB::table('services')->where('id',$Portfolio->service)->get(); ?>
                          ...
                          <option selected value="<?php echo e($Portfolio->service); ?>"><?php $__currentLoopData = $Servicee; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $servicee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php echo e($servicee->title); ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></option>
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/designekta/stagepassRevamps/resources/views/admin/editPortfolio.blade.php ENDPATH**/ ?>