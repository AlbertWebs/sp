                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                            ...
                                            @foreach($Portfolio as $value)
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td class="center">
                                                        <a href="{{url('/admin')}}/editPortfolio/{{$value->id}}"   class="btn btn-info"><i class="icon-pencil icon-white"></i> Edit</a>
                                                        <br><br>
                                                        <a href="{{url('/admin')}}/dropzone/{{$value->id}}"   class="btn btn-info"><i class="icon-image icon-white"></i> Add Images (<?php echo count($PortFolio = DB::table('photos')->where('portfolio_id',$value->id)->get()) ?>)</a>
                                                    </td>
